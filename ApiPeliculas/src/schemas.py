...
class PeliculaBaseModel(BaseModel):
    ...
    def descripcion_validator(cls, Descripcion):
        if len(Descripcion) < 3 or len(Descripcion) > 400:
            raise ValueError("La longitud de la descripcion se debe de encontrar entre los 3 y 400 caracteres")
    ...
    def clasificacionEdad_validator(cls, ClasificacionEdad):
        if ClasificacionEdad < 1 or ClasificacionEdad > 6:
            raise ValueError("La clasificacion de edad se debe de encontrar entred 1 y 6 años")
...
class PeliculaPutModel(BaseModel):
    ...
    def clasificacionEdad_validator(cls, ClasificacionEdad):
        if ClasificacionEdad < 1 or ClasificacionEdad > 6:
            raise ValueError("La clasificacion de edad se debe de encontrar entre 1 y 6 años")
